from neo4j_for_django.contrib.sessions.exceptions import N4DSessionDoesNotExist
...
class SessionStore(SessionBase):
    ...
    def _get_session_from_db(self):
        ...
        except (N4DSessionDoesNotExist, SuspiciousOperation) as e:
    ...
    def load(self):
        ...
        session_data = s[0]['s']['session_data']
    ...
    def delete(self, session_key=None):
        ...
        try:
            self.model.delete(session_key=session_key)
